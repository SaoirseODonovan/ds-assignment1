...
export const handler: APIGatewayProxyHandler = async (event) => {
  try {
    ...
    //references for translate endpoint:
    //video recommended in spec: https://www.youtube.com/watch?v=xdWpbr1DZHQ&t=1288s
    //transcript:https://completecoding.io/typescript-translation-api/
